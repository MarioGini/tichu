...
class GameSnapshot {
  ...
  final String? pendingAiPlayerId;
  final List<Card> pendingAiCards;
  final bool pendingAiPass;
  final ScoreState scoreState;
  final bool aiAwaitingConfirmation;
  ...
  const GameSnapshot({
    ...
    required this.pendingAiPlayerId,
    required this.pendingAiCards,
    required this.pendingAiPass,
    required this.scoreState,
    required this.aiAwaitingConfirmation,
    required this.phase,
...
class ConfirmAiTurnAction extends GameAction {
  const ConfirmAiTurnAction({required super.playerId});
}
