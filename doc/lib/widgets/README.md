...
Reusable, cross-screen UI components for card game presentation and interaction.

## Implemented Here
- `action_bar.dart`: phase/action controls UI.
- `card_widget.dart`: single card visual component.
